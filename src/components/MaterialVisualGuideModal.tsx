...
import { MATERIAL_IMAGES } from '../utils/materialImages';
...
const MATERIAL_MEMBERS: MemberDetail[] = [
  {
    ...
    color: '#2563eb',
    photoUrl: MATERIAL_IMAGES.overview || '/assets/materials/overview.jpg',
  ...
  },
  {
    ...
    color: '#0284c7',
    photoUrl: MATERIAL_IMAGES.hpile_lagging || '/assets/materials/hpile_lagging.jpg',
  ...
  },
  {
    ...
    color: '#7c3aed',
    photoUrl: MATERIAL_IMAGES.wale_wedge_jack || '/assets/materials/wale_wedge_jack.jpg',
  ...
  },
  {
    ...
    color: '#059669',
    photoUrl: MATERIAL_IMAGES.bracing || '/assets/materials/bracing.jpg',
  ...
  },
  {
    ...
    color: '#475569',
    photoUrl: MATERIAL_IMAGES.deck_girder || '/assets/materials/deck_girder.jpg',
