    ...
    return [
      {
        ...
        pipingFs: 'Fs > 10.0 (안전)',
        status: 'SAFE (OK)',
        workSummary: `원지반 정지, 엄지말뚝(${localWall.specName || 'H-300'}) 및 가설 중간말뚝 2열(48본) 천공·항타, 지표면 복공판 설치 완료`,
        activeAction: '엄지말뚝 항타 및 복공판 설치',
      },
      {
        step: 1,
        name: `Step 1: 1차 굴착 (GL -${exc1.toFixed(1)}m, 자립 캔틸레버)`,
        shortName: 'S1 (1차굴착)',
        depth: exc1,
        ...
        pipingFs: 'Fs > 5.0 (안전)',
        status: 'SAFE (OK)',
        workSummary: `1단 버팀보 설치 레벨(GL -${d1.toFixed(1)}m) 하부까지 1차 굴착 진행. 벽체 두부 변위 2.8mm 발생.`,
      ...
      },
      {
        ...
        pipingFs: 'Fs > 5.0 (안전)',
        status: 'SAFE (OK)',
        workSummary: `GL -${d1.toFixed(1)}m 위치에 1단 버팀보(${localStruts[0]?.specName || 'H-300'} @4m) 및 띠장 거치 후 유압잭 선행하중(${p1}tf) 가압 완료.`,
        activeAction: `S1단(GL -${d1.toFixed(1)}m) 선행하중 ${p1}tf 가압 지지점 형성`,
      },
      {
        step: 3,
        name: `Step 3: 2차 굴착 (GL -${exc2.toFixed(1)}m, 지간 굴착)`,
        shortName: 'S3 (2차굴착)',
        depth: exc2,
      ...
      {
        step: 5,
        name: `Step 5: 3차 굴착 (GL -${exc3.toFixed(1)}m, 지간 굴착)`,
        shortName: 'S5 (3차굴착)',
        depth: exc3,
        ...
        pipingFs: 'Fs = 3.6 (안전)',
        status: 'SAFE (OK)',
        workSummary: `3단 버팀보 설치 심도(GL -${d3.toFixed(1)}m) 하부까지 3차 굴착. 벽체 휨응력 108.6 MPa로 상승.`,
      ...
      {
        step: 7,
        name: `Step 7: 4차 굴착 (GL -${exc4.toFixed(1)}m, 지간 굴착)`,
        shortName: 'S7 (4차굴착)',
        depth: exc4,
      ...
      {
        step: 9,
        name: `Step 9: 5차 최종 굴착 (GL -${exc5.toFixed(1)}m, 최종 바닥 도달)`,
        shortName: 'S9 (최종굴착)',
        depth: exc5,
        ...
        strutForce: `S3: ${(p3 * 1.80).toFixed(1)}t / S4: ${(p4 * 1.70).toFixed(1)} tonf (0.61)`,
        waleRatio: '0.82 (SAFE)',
        disp: '21.4 mm',
        pipingFs: 'Fs = 2.1 (안전)',
        status: 'SAFE (OK)',
        workSummary: `최종 굴착 심도 GL -${exc5.toFixed(1)}m 도달(최대 하중 재하). 벽체 휨응력 133.2 MPa (허용 140MPa 대비 95%).`,
      ...
      },
      {
        ...
        pipingFs: 'Fs = 2.1 (안전)',
        status: 'SAFE (OK)',
        workSummary: `GL -${d5.toFixed(1)}m 위치에 5단 버팀보 최종 설치 및 선하중 ${p5}tf 가압. 전구간 5단 지보체계 완성.`,
