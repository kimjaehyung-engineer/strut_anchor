...
export const STRUT_SPECS: StrutSpec[] = [
  // --- [1] H-형강 버팀보 (H-Pile / H-Beam Strut) ---
  {
    id: 'strut-h-300-305',
  ...
  {
    id: 'strut-h-300-300',
    name: 'H-300×300×10×15 버팀보 (SM355 표준)',
    category: 'H_BEAM',
    section: 'H-300×300×10×15',
    areaA: 119.8,
    momentOfInertiaI: 20400,
    sectionModulusZ: 1360,
    allowableAxialStress: 160,
    unitWeight: 94.0,
    jackSpec: '스크류잭 1,000kN (100tonf)',
    wedgeSpec: '화타쐐기 K-1 TYPE',
    connectionSpec: 'S-2 TYPE 플랜지 연결',
  },
  {
    id: 'strut-h-350-350',
    name: 'H-350×350×12×19 버팀보 (SM355 중대형)',
    category: 'H_BEAM',
    section: 'H-350×350×12×19',
    areaA: 173.9,
    momentOfInertiaI: 40300,
    sectionModulusZ: 2300,
    allowableAxialStress: 160,
    unitWeight: 137.0,
    jackSpec: '스크류잭 1,000kN / 1,500kN',
    wedgeSpec: '화타쐐기 K-1 TYPE',
    connectionSpec: 'S-2 TYPE 볼트 연결',
  },
  {
    id: 'strut-h-400-400',
    name: 'H-400×400×13×21 버팀보 (SM355 대심도 고강도)',
    category: 'H_BEAM',
    ...
    allowableAxialStress: 160,
    unitWeight: 172.0,
    jackSpec: '스크류잭 1,500kN (150tonf)',
    wedgeSpec: '화타쐐기 K-1 TYPE',
    connectionSpec: 'S-2 TYPE 대형 고력볼트 이음',
  },
  {
    id: 'strut-h-250-250',
    name: 'H-250×250×9×14 버팀보 (SS275 소구간용)',
    category: 'H_BEAM',
    section: 'H-250×250×9×14',
    areaA: 92.2,
    momentOfInertiaI: 10800,
    sectionModulusZ: 864,
    allowableAxialStress: 140,
    unitWeight: 72.4,
    jackSpec: '스크류잭 700kN (70tonf)',
    wedgeSpec: '화타쐐기 K-1 TYPE',
    connectionSpec: 'S-1 TYPE 연결',
  },

  // --- [2] 원형 강관 버팀보 (Circular Steel Pipe Strut) ---
  {
    id: 'strut-pipe-508-95',
    name: '원형강관 버팀보 Φ508×9.5t (STK490 / SM355)',
    category: 'PIPE',
    section: 'Φ508×9.5t',
    outerDiameter: 508.0,
    thickness: 9.5,
  ...
  {
    id: 'strut-pipe-508-11',
    name: '원형강관 버팀보 Φ508×11.0t (STK490)',
    category: 'PIPE',
    section: 'Φ508×11t',
    outerDiameter: 508.0,
    thickness: 11.0,
  ...
  },
  {
    ...
    name: '원형강관 버팀보 Φ609.6×12.0t (STK490 / SM355 표준)',
    category: 'PIPE',
    section: 'Φ609.6×12t',
    outerDiameter: 609.6,
    thickness: 12.0,
  ...
  },
  {
    ...
    name: '원형강관 버팀보 Φ609.6×14.0t (STK490 고내력)',
    category: 'PIPE',
    section: 'Φ609.6×14t',
    outerDiameter: 609.6,
    thickness: 14.0,
  ...
  },
  {
    ...
    name: '원형강관 버팀보 Φ711.2×14.0t (STK490)',
    category: 'PIPE',
    section: 'Φ711.2×14t',
    outerDiameter: 711.2,
    thickness: 14.0,
  ...
  {
    id: 'strut-pipe-711-16',
    name: '원형강관 버팀보 Φ711.2×16.0t (STK490 대심도)',
    category: 'PIPE',
    section: 'Φ711.2×16t',
    outerDiameter: 711.2,
    thickness: 16.0,
  ...
  {
    id: 'strut-pipe-812-16',
    name: '원형강관 버팀보 Φ812.8×16.0t (STK490 대구경)',
    category: 'PIPE',
    section: 'Φ812.8×16t',
    outerDiameter: 812.8,
    thickness: 16.0,
    ...
    sectionModulusZ: 7870,
    allowableAxialStress: 160,
    unitWeight: 314.0,
    jackSpec: '유압 스크류잭 2,000kN',
    wedgeSpec: '화타쐐기 K-1 TYPE',
    connectionSpec: '대구경 플랜지 고력볼트 이음',
  },

  // --- [3] 어스앵커 (Ground Anchor) ---
  {
    id: 'strut-anchor-pc127',
    name: '어스앵커 PC강선 φ12.7mm (4가닥) - D105mm 천공',
    category: 'ANCHOR',
  ...
  {
    id: 'strut-anchor-pc127-5',
    name: '어스앵커 PC강선 φ12.7mm (5가닥) - D115mm 천공',
    category: 'ANCHOR',
    section: 'φ12.7mm 5가닥 (D115mm 천공)',
    areaA: 4.935,
    momentOfInertiaI: 0,
    sectionModulusZ: 0,
    allowableAxialStress: 1200,
    unitWeight: 3.9,
    jackSpec: 'PC 유압 인장기 (고용량)',
    wedgeSpec: '지압판 Base Plate (350×350×28t)',
    connectionSpec: '풍화토/풍화암 천공 D115mm 그라우팅',
  },
];
